...
export function DownloadLink({ email = "" }: { email: string }) {
	return (
		<Html>
			<Head />
			<Preview>Download FlowReco — the open source Loom alternative</Preview>
			<Tailwind>
				<Body className="mx-auto my-auto bg-gray-1 font-sans">
					<Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
						...
						<Heading className="mx-0 my-7 p-0 text-center text-xl font-semibold text-black">
							Your FlowReco download links are here
						</Heading>
						<Text className="text-sm leading-6 text-black">
							Thanks for your interest in FlowReco! Here are the download links for
							every platform:
						</Text>
						...
						<Text className="text-sm leading-6 text-black mt-4">
							FlowReco is the open source alternative to Loom. Beautiful, shareable
