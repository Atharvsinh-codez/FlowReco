...
mod tests {
    ...
    #[test]
    fn default_frame_chrome_uses_a_local_reco_url() {
        let frame = FrameConfiguration::default();

        assert_eq!(frame.url, "reco.local");
        assert!(!frame.url.to_lowercase().contains("cap"));
    }
