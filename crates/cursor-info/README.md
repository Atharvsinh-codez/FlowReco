# FlowReco Cursor Info

A cross-platform Rust crate for detecting cursor shapes and rendering FlowReco's original cursor theme with accurate hotspot information.
...
- 🎨 **Original SVG assets** - Scalable FlowReco cursor graphics for supported shapes
...
- **Design**: Original FlowReco geometry rather than reproductions of system artwork
- **Hotspots**: Derived from the matching 32 × 32 SVG geometry
- **License**: Distributed under the repository license; see `assets/README.md`
...
The original FlowReco cursor artwork and this crate are distributed under the repository license. Platform names identify detected cursor semantics and do not indicate ownership of the rendered artwork.
