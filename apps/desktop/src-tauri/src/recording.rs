...
use cap_project::{
    CameraShape, CursorClickEvent, InstantRecordingMeta, MultipleSegments,
    Platform, ProjectConfiguration, RecordingMeta, RecordingMetaInner, SharingMeta,
    StudioRecordingMeta, StudioRecordingStatus, TimelineConfiguration, TimelineSegment,
...
fn generate_zoom_segments_from_clicks_impl(
    ...
    crate::auto_zoom::generate_zoom_segments(
        &clicks,
        &moves,
        max_duration,
        &crate::auto_zoom::AutoZoomConfig::default(),
    )
}
...
fn apply_recording_presentation_defaults(
    ...
    let default_wallpaper_path = if using_default_config {
        stored_desktop_background_path.or_else(|| {
            app.path()
                .resolve(
                    "assets/backgrounds/flowreco/graphite-orbit.jpg",
