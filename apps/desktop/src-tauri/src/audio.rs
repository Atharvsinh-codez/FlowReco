...
impl AppSounds {
    ...
    fn get_sound_bytes(&self) -> &'static [u8] {
        match self {
            AppSounds::StartRecording => include_bytes!("../sounds/start-recording.wav"),
            AppSounds::StopRecording => include_bytes!("../sounds/stop-recording.wav"),
            AppSounds::Screenshot => include_bytes!("../sounds/screenshot.wav"),
            AppSounds::Notification => include_bytes!("../sounds/action.wav"),
        }
    }
}
