...
pub fn apply_liquid_glass_background(
    ...
    unsafe {
        ...
        // which dims the material whenever another FlowReco window (camera, settings, etc.)
        ...
        // sampling while FlowReco was unfocused, but an occlusion-suppressed surface is one
