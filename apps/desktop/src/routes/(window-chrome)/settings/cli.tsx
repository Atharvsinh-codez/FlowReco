	...
	return (
		<div class="cap-settings-page flex flex-col h-full custom-scroll">
			<SettingsPageContent>
				<Section
					title="Command Line"
					description="Install the bundled command-line bridge for terminals, agents, scripts, and local automation."
				>
					<SectionCard padded>
						<Show
									...
									<div class="flex items-start justify-between gap-4">
										<div class="flex flex-col gap-1 min-w-0">
											...
											<p class="text-xs leading-snug text-gray-10">
												For compatibility, FlowReco currently installs the
												legacy <code class="font-mono text-gray-12">cap</code>{" "}
									...
									>
										<div class="flex flex-col gap-2 rounded-lg border border-gray-4 bg-gray-3 px-3 py-3">
											<p class="text-xs leading-relaxed text-gray-10">
												<Show
													...
													fallback={
														<>
															...
															to your PATH to use the legacy{" "}
												...
												>
													Added the legacy{" "}
													<code class="font-mono text-gray-12">cap</code> to
