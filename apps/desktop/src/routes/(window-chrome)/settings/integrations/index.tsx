	...
	const apps = [
		{
			name: "Google Drive",
			description:
				"Connect Google Drive for new shareable-link uploads. New videos are stored in a private application folder and served through your configured FlowReco server after normal access checks.",
	...
	return (
		<div class="cap-settings-page flex flex-col h-full custom-scroll">
			<SettingsPageContent>
				<Section
					title="Integrations"
					description="Connect FlowReco to storage providers and third-party services."
				>
					<div class="space-y-3">
						<For each={apps}>
							{(app) => (
