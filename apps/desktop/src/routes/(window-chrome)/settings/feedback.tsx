...
export default function FeedbackTab() {
	...
	const handleUploadLogs = async () => {
		...
		try {
			...
			toast.error("Logs couldn't be uploaded. Try again.");
	...
	return (
		<div class="cap-settings-page flex flex-col w-full h-full custom-scroll">
			<SettingsPageContent>
				<Section
					title="Feedback"
					description="Help improve FlowReco by sharing feedback or reporting a bug."
				>
					<form
						class="space-y-4"
						onSubmit={(e) => {
				...
				<Section
					...
					description="Upload FlowReco diagnostics when support asks for them. Review the diagnostics before sharing."
				>
					<Button
