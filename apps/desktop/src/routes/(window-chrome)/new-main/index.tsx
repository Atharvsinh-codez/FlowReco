		...
		toast.custom(
			(t) => (
				...
				<div class="flex flex-col gap-2.5 px-4 py-3 rounded-xl border shadow-lg bg-gray-1 border-gray-4 text-gray-12 w-[min(24rem,calc(100vw-2rem))]">
					<p class="text-sm">
						{update.installed
							? `FlowReco ${update.version} has been installed — restart to apply`
							: `FlowReco ${update.version} is ready to install`}
					</p>
					<div class="flex gap-2 items-center">
						<button
							...
							onClick={() => {
								...
								// On Windows the NSIS installer restarts FlowReco itself, so the
