	...
	return (
		...
		>
			...
			>
				...
				<div
					class={cx(
						"absolute bottom-0 rounded-[var(--radius-xs,4px)] z-20 w-px pointer-events-none bg-linear-to-b to-120% from-[var(--sleek-accent,#0284c7)]",
						split() && "opacity-50",
					)}
					style={{
						left: `${TIMELINE_PADDING + TRACK_GUTTER}px`,
				...
				>
					<div class="size-3 bg-[var(--sleek-accent,#0284c7)] rounded-[var(--radius-sm,6px)] -mt-2 -ml-[calc(0.37rem-0.5px)] shadow-[0_0_0_1px_rgba(2,132,199,0.35)]" />
				</div>
				<div
