...
// FlowReco does not bundle third-party music. Keeping this map makes future
// explicitly licensed local packs previewable without changing the editor API.
...
export function AudioLibraryPanel(props: {
	...
	return (
		<div class="flex flex-col gap-4">
			...
			<Show when={!library.loading && categories().length === 0}>
				<div class="flex items-start gap-3 rounded-xl border border-gray-4 bg-gray-2 p-3.5">
					<span class="flex size-8 shrink-0 items-center justify-center rounded-lg bg-gray-3 text-gray-10">
						<IconLucideMusic2 class="size-4" />
					</span>
					<div>
						<p class="text-xs font-medium text-gray-12">
							Your audio, kept local
						</p>
						<p class="mt-0.5 text-[11px] leading-4 text-gray-9">
							Import a track from your device. FlowReco copies it into the
							project so reopening and export stay reliable.
						</p>
					</div>
				</div>
			</Show>
