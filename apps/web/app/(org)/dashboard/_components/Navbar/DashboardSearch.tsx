...
const formatVideoSubtitle = (video: DashboardVideoSearchResult) => {
	const parts = [
		video.isScreenshot ? "Screenshot" : "Recording",
		...
		() => [
			{
				id: "my-recordings",
				title: "Recordings",
				subtitle: "Open your recording library",
				href: "/dashboard/caps",
				value: "recordings videos library",
				icon: FileVideo,
			},
			{
				id: "new-recording",
				...
				value: "new recording screen video browser recorder",
				icon: Radio,
			},
			{
				id: "import-video",
				title: "Import Media",
				subtitle: "Bring an existing video or image into FlowReco",
			...
			...(canViewSettings
				? [
						...
						},
						{
							...
							value:
								"recording defaults settings preferences summaries captions chapters comments reactions transcript",
							icon: Sparkles,
						},
					]
				: []),
