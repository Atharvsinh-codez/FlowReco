...
const options: Array<{
	...
	{
		label: "Show FlowReco logo",
		value: "hideShareableLinkCapLogo",
		description: "Show FlowReco branding at the top of shareable links",
		pro: true,
	},
];
			...
			<div className="flex flex-col gap-3 p-4 text-left rounded-xl border transition-colors bg-gray-2 border-gray-3 sm:flex-row sm:justify-between sm:items-center">
				<div className="flex flex-col flex-1 gap-1">
					...
					<p className="text-xs text-gray-10">
						The speed recordings start playing at on shareable links. Viewers
						can still change it.
					</p>
				</div>
