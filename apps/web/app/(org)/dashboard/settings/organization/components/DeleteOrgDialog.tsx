		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent>
				<DialogHeader
					...
					description="Removing your organization will delete its memberships, invites, spaces, shared recordings, analytics, and server-hosted media. Custom storage files are not deleted."
				>
