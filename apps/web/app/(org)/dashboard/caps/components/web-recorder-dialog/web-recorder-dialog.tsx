...
export const WebRecorderDialog = () => {
	...
	useEffect(() => {
		...
		const startSound = new Audio("/sounds/start-recording.wav");
		startSound.preload = "auto";
		const stopSound = new Audio("/sounds/stop-recording.wav");
	...
	const handleOpenChange = (next: boolean) => {
		if (next && supportCheckCompleted && !isBrowserSupported) {
			toast.error(
				"This browser isn't compatible with FlowReco's web recorder. We recommend Google Chrome or another Chromium-based browser.",
			);
			return;
		}
