...
export const RecordVideoPage = () => {
	...
	const openDesktop = useCallback(() => {
		...
		// Keep FlowReco's registered protocol for compatibility with existing desktop installs.
					...
					<div className="mx-auto w-full max-w-[560px] min-w-0">
						<div className="flex flex-col items-center">
							<p className="max-w-md text-gray-10 text-md">
								Choose how you'd like to create a FlowReco recording.
							</p>
						</div>
...
const FaqAccordion = () => {
	...
	const items = [
		{
			id: "what-is-reco",
			q: "What is a FlowReco recording?",
			a: "A FlowReco recording captures your screen, camera, or both and can be edited locally or shared with a link.",
		},
		{
			id: "how-it-works",
			q: "How does it work?",
		...
		},
		{
			...
			a: "On compatible browsers, selecting a camera opens a picture‑in‑picture window that’s captured when you record fullscreen. We recommend recording fullscreen to keep it on top. If PiP capture isn’t supported, your camera stays within the FlowReco recorder tab.",
		},
		{
		...
		},
		{
			...
			a: "Browsers limit system‑wide audio capture. We recommend using FlowReco Desktop for best results.",
		},
		{
			id: "install",
			q: "Do I need to install the app?",
			a: `No. You can record in your browser. For longer recordings, system audio, and advanced editing, use FlowReco Desktop. On the default hosted server, standard accounts support up to ${freeMinutes} minutes per browser recording. Self-hosted limits depend on server policy.`,
		},
	];
