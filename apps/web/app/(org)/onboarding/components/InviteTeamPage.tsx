...
export function InviteTeamPage() {
	...
	const planCheckout = async (e: MouseEvent<HTMLButtonElement>) => {
		...
		try {
			...
			if (data.subscription === true) {
				toast.success("You already have a hosted Pro plan");
				return;
			}
	...
	if (!isHostedCap) {
		return (
			<Base
				...
				description="Invite teammates from workspace settings whenever you're ready."
			>
				<Button
					variant="dark"
	...
	return (
		<Base
			...
			description="Invite members to your organization and share FlowReco recordings together."
		>
