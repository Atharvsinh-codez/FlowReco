...
<html lang="en">
	...
	<body>
		<main>
			<h1>Opening FlowReco</h1>
			<p>If FlowReco does not open automatically, try the button below. Browser fallback will start in a moment.</p>
			<div class="actions">
				<button id="open-cap" type="button">Open FlowReco</button>
		...
		<script>
			...
			const openCap = () => {
				status.textContent = "Trying to open the FlowReco desktop app...";
