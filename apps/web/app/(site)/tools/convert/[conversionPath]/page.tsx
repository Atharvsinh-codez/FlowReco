...
export async function generateMetadata(
	...
	if (!CONVERSION_CONFIGS[conversionPath]) {
		return {
			title: "Conversion Not Supported | FlowReco",
			description:
	...
	return {
		title: `${sourceUpper} to ${targetUpper} Converter | Free Online Tool | FlowReco`,
			...
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `FlowReco ${sourceUpper} to ${targetUpper} Converter Tool`,
				},
			],
		},
		alternates: {
...
export default async function ConversionPage(props: ConversionPageProps) {
	...
	const pageContent: ToolPageContent = {
		...
		cta: {
			...
			description:
				"Record, edit, and share video messages with FlowReco. 100% open source and privacy focused.",
