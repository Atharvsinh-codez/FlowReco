...
export const metadata: Metadata = {
	title:
		"Video Speed Controller Online – Speed Up or Slow Down Videos Free | FlowReco",
	description:
		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: "FlowReco Video Speed Controller — Free Online Video Speed Changer",
			},
		],
		locale: "en_US",
		type: "website",
...
const faqs = [
	{
		...
		answer:
			"Open FlowReco's Video Speed Controller, drag and drop your video file (or click to browse), select your target speed from 0.25× to 3×, then click Speed Up or Slow Down Video. The entire process runs in your browser — your file never leaves your device. Once processing is complete, preview and download the result.",
	},
	{
...
const howToSteps = [
	{
		...
		text: "Open FlowReco's Video Speed Controller and drag and drop your video into the upload area, or click to browse your files. Supported formats include MP4, WebM, MOV, AVI, and MKV up to 500 MB.",
	},
	{
...
const howToStructuredData = {
	...
	description:
		"Adjust the playback speed of any video for free using FlowReco's browser-based speed controller. No upload required.",
...
export default function SpeedControllerPage() {
	const pageContent: ToolPageContent = {
		...
		cta: {
			...
			description:
				"Record, edit, and share video messages with FlowReco. 100% open source and privacy focused. No speed adjustments needed — just hit record.",
