...
const features: Feature[] = [
	...
	},
	{
		...
		description:
			"Record and store everything locally with FlowReco Studio Mode - your data never leaves your device",
		category: "privacy",
		size: "medium",
	},
	{
	...
	},
	{
		icon: faServer,
		title: "Self-Hosting",
		description: "Deploy FlowReco on your own infrastructure for ultimate control",
		category: "privacy",
	},

	{
		...
		description:
			"Switching from Loom? Import your existing Loom recordings directly into FlowReco and keep all your content in one place",
		category: "platform",
		size: "medium",
	},
	{
	...
	},
	{
		icon: faInfinity,
		title: "No Watermarks",
		description: "Your recordings are yours - no FlowReco watermarks ever",
		category: "editing",
	},
	...
	},
	{
		...
		title: "Webhooks & API",
		description:
			"Integrate FlowReco into your workflow with webhooks and API access",
		category: "platform",
		isPro: true,
		isComingSoon: true,
		size: "medium",
			...
			<div className="relative z-10 px-5 pt-32 pb-20 w-full">
				<div className="mx-auto text-center wrapper wrapper-sm">
					...
					<p className="mx-auto mb-8 max-w-3xl text-md sm:text-xl text-gray-10">
						Whether you're a solo creator or a global agency, FlowReco scales with
