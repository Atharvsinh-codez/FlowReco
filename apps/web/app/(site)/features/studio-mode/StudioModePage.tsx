...
const studioModeConfig: FeaturePageConfig = {
	...
	content: {
		hero: {
			...
			primaryCta: "Download FlowReco Free",
		...
		faq: {
			...
			items: [
				...
				},
				{
					...
					answer:
						"Yes, Studio Mode is available as part of the FlowReco desktop application for both macOS (Intel and Apple Silicon) and Windows.",
				},
				{
					question: "How does pricing work for Studio Mode?",
					answer:
						"Studio Mode is completely free for personal usage. For commercial usage, you need the Desktop License, which is included with FlowReco Pro or can be purchased separately.",
				},
			],
		},
		video: {
			...
			iframe: {
				...
				title: "Studio Mode Demo - FlowReco Screen Recording",
			},
		},
		cta: {
			title: "Start Creating Professional Content Today",
			description:
				"Download FlowReco and experience the power of Studio Mode for yourself. Create stunning, professional-quality recordings that engage your audience.",
			primaryButton: "Download FlowReco Free",
