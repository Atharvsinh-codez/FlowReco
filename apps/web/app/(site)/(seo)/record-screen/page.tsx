...
export const metadata: Metadata = {
	title: "Record Screen — Free HD Screen Recorder with Instant Sharing | FlowReco",
	description:
		"Record your screen in HD on Mac or Windows with FlowReco. Capture audio, webcam overlay, and share with a link instantly. Free, open-source, no watermarks, no time limits in Studio Mode.",
	alternates: {
		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: "FlowReco: Record Your Screen for Free",
			},
		],
		locale: "en_US",
		type: "website",
