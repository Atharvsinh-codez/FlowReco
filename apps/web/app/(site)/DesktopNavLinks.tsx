...
const Links: NavItem[] = [
	{
		...
		dropdown: [
			...
			{
				label: "Open Source",
				sub: "FlowReco is open source and available on GitHub",
				href: FLOWRECO_SOURCE_REPOSITORY,
			},
			{
				label: "Self-host FlowReco",
				sub: "Self-host FlowReco on your own infrastructure",
				href: "/self-hosting",
			},
			{
				label: "Report an issue",
				sub: "Bugs, requests, and project discussion on GitHub",
	...
	},
	{
		...
		dropdown: [
			{
				label: "Support",
				sub: "Documentation and community support",
				href: "/support",
			},
			{
				label: "Documentation",
				sub: "Documentation for using FlowReco",
				href: "/docs",
			},
			{
				label: "FAQs",
				sub: "Frequently asked questions about FlowReco",
				href: "/faq",
			},
			{
				label: "GitHub issues",
				sub: "Ask for help or report a bug",
				href: `${FLOWRECO_SOURCE_REPOSITORY}/issues`,
			},
		],
	},
