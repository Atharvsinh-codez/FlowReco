			...
			<DialogContent className="w-[90vw] bg-gray-3 relative sm:max-w-md p-6 rounded-xl">
				{emailSent && (
					<button
						...
						className="absolute top-5 left-5 z-20 flex gap-2 items-center py-1.5 px-3 text-xs text-gray-12 bg-transparent border border-gray-4 rounded-full hover:bg-gray-1"
					>
				...
				<div className="space-y-6">
					...
					<div className="flex flex-col">
						...
						<p className="mt-6 text-xs text-center text-gray-9">
							By entering your email, you confirm that you have read and agree
							to FlowReco's{" "}
							<Link
								href="/terms"
								target="_blank"
