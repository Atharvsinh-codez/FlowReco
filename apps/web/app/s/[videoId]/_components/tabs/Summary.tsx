		...
		return (
			<div className="flex flex-col justify-center items-center p-8 h-full text-center">
				<div className="space-y-4 max-w-sm">
					<div className="p-6 rounded-lg border bg-gray-2 border-gray-4">
						<div className="mb-3 text-[#ff6243]">
							<Sparkles className="mx-auto size-8" aria-hidden="true" />
						</div>
						<h3 className="mb-2 text-lg font-semibold text-gray-900">
							AI features need server access
						</h3>
						<p className="mb-4 text-sm text-gray-600">
							This FlowReco server requires AI access for automatic titles, video
							...
							<div className="divide-y">
								{aiData.chapters.map((chapter) => (
									<button
										type="button"
										key={chapter.start}
										className="flex items-center p-2 w-full text-left rounded hover:bg-gray-100"
										onClick={() => handleSeek(chapter.start)}
									>
										<span className="w-16 text-xs tabular-nums text-gray-500">
