...
export function CapVideoPlayer({
	...
	const rawPlaybackBadgeDescription =
		uploadProgressRaw?.status === "error"
			...
			: "This page is temporarily playing the original uploaded file while FlowReco finishes processing the optimized version for smoother playback and broader compatibility.";
				...
				{showPlayButton &&
					...
					!showPlaybackResolutionError && (
						<motion.button
							...
							className="flex absolute inset-0 z-10 justify-center items-center m-auto bg-blue-500 rounded-full transform hover:bg-blue-600 size-12 xs:size-20 md:size-32"
						>
							<FontAwesomeIcon
								icon={faPlay}
