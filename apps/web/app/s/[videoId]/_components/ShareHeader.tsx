...
export const ShareHeader = ({
	...
	const handleHideBranding = async () => {
		...
		try {
			...
			toast.success("FlowReco logo hidden");
			refresh();
		} catch (error) {
			toast.error(
				error instanceof Error ? error.message : "Failed to hide FlowReco logo",
			);
		} finally {
