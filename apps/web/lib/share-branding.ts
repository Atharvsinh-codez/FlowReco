 ...
 * Pro organizations can show a custom icon or hide the FlowReco logo entirely;
 * free organizations always fall back to the FlowReco logo.
 */
 ...
 * organization has opted to hide the FlowReco logo and has no custom icon set.
 */
