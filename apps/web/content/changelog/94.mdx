...
- **Camera reliability** — Camera preview now detects stalls and auto-refreshes, restores correctly when reopening FlowReco or waking from sleep, and always cleans up feeds when recording ends.
...
- **Cmd/Ctrl+W to close windows** — Standard keyboard shortcut now works to close any FlowReco window.
