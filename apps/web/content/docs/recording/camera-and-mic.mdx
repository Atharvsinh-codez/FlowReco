...
FlowReco lets you include a camera overlay and microphone audio in your recordings. This guide covers how to select your devices, configure settings, and troubleshoot common issues on macOS and Windows.

## Camera

### Selecting a Camera

FlowReco automatically detects all available cameras connected to your system. To choose which camera to use:

1. Open FlowReco Desktop.
2. Click the **camera** dropdown next to the camera toggle.
3. Select your preferred camera from the list.

FlowReco remembers your selection between sessions. If you disconnect a camera and reconnect it later, FlowReco will resume using it automatically.
...
FlowReco detects all available audio input devices on your system. To choose your microphone:
...
Before you start recording, FlowReco shows an audio level indicator so you can verify your microphone is picking up sound. Speak normally and watch for the level meter to respond. This helps you catch issues like a muted microphone or wrong device selection before you start recording.

### System Audio

In addition to microphone audio, FlowReco can capture system audio (the sound playing through your computer). This is useful for:
...
macOS requires explicit permission for apps to access your camera and microphone. FlowReco will prompt you the first time you try to use each device.

**Camera Permission**

1. When you first enable the camera, macOS shows a permission dialog.
2. Click **Allow** to grant access.
3. If you accidentally denied the permission, you can fix it in **System Settings** > **Privacy & Security** > **Camera** and toggle FlowReco on.

**Microphone Permission**

1. When you first enable the microphone, macOS shows a permission dialog.
2. Click **Allow** to grant access.
3. If you accidentally denied the permission, go to **System Settings** > **Privacy & Security** > **Microphone** and toggle FlowReco on.

After changing permissions in System Settings, you may need to restart FlowReco for the changes to take effect.
...
1. Windows will prompt you when FlowReco first tries to access the camera.
2. Click **Yes** to allow.
3. To manage later: **Settings** > **Privacy** > **Camera** and ensure FlowReco is allowed.

**Microphone Permission**

1. Windows will prompt you when FlowReco first tries to access the microphone.
2. Click **Yes** to allow.
3. To manage later: **Settings** > **Privacy** > **Microphone** and ensure FlowReco is allowed.
...
- **Check permissions.** Verify that FlowReco has camera permission in your system settings.
...
- **Restart FlowReco.** Close and reopen FlowReco Desktop to refresh the device list.

### Microphone Not Working

- **Check the audio level indicator.** If it does not respond when you speak, FlowReco is not receiving audio from the selected device.
- **Verify device selection.** Make sure you have the correct microphone selected in the dropdown.
- **Check permissions.** Verify that FlowReco has microphone permission in your system settings.
...
- **Verify the camera toggle is on.** The camera button in FlowReco Desktop should be active (highlighted).
- **Check that the camera feed is visible** in the FlowReco preview before starting your recording.
- **Restart FlowReco** if the camera was connected after FlowReco was opened.
