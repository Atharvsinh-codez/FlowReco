...
FlowReco provides analytics for your shared recordings so you can understand who is viewing your content and how your recordings are performing over time. Analytics are available on your FlowReco dashboard for every recording you have shared.
...
Unique views are tracked using anonymous session identifiers. FlowReco does not collect personally identifiable information about viewers unless they are signed in with a FlowReco account.

## Dashboard Overview

Your FlowReco dashboard provides a high-level view of all your recordings with key metrics visible at a glance:
...
For team standups and updates shared via FlowReco, analytics confirm whether your teammates are actually watching. If view counts are low, consider adjusting your sharing approach or recording format.
...
Available analytics depend on the features enabled by the FlowReco server operator; the open-source project does not impose a subscription gate.

**Can I see who specifically watched my recording?**

FlowReco prioritizes viewer privacy. Analytics show aggregate data like view counts and unique view counts. Individual viewer identification is not provided for general share links.
