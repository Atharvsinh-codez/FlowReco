export const recordScreenWindowsContent = {
	...
	description:
		"Learn how to record your screen with crisp internal audio on Windows 11—without Stereo Mix. Capture mic + system sound together using FlowReco. Step-by-step setup, fixes, and FAQs.",
	...
	heroTLDR:
		"You don't need the old Stereo Mix device. FlowReco uses modern WASAPI loopback capture to record exactly what's playing through your speakers or headphones, plus your microphone, in just a couple of clicks.",
	...
	methods: [
		{
			title: "Method 1: FlowReco (Fastest Path)",
			description:
				"FlowReco makes it simple to record your Windows screen with system audio using modern WASAPI loopback:",
			steps: [
				{
					title: "Step 1: Install FlowReco",
					content:
						'Download and install FlowReco from <a href="/download">FlowReco.so/download</a>.',
				},
				{
          ...
          `,
				},
				{
					...
					content: `
            <ol>
              <li>Open FlowReco and choose your recording mode (Instant or Studio)</li>
            ...
            <p><strong>Pro Tip:</strong> FlowReco captures both audio sources on separate tracks so you can adjust levels independently in the editor.</p>
          `,
				},
			],
		},
		{
            ...
            <p><strong>Use FlowReco instead</strong> for better control and desktop recording capabilities.</p>
          `,
				},
			],
		},
	...
	troubleshooting: {
		...
		items: [
			...
			},
			{
				...
				answer:
					"Double-check the Volume mixer settings and confirm the app is playing to the output device FlowReco is monitoring. FlowReco captures from your default output device using WASAPI loopback.",
			},
			{
				question: "Can't find Stereo Mix on Windows 11",
				answer:
					"Many modern devices hide Stereo Mix or don't include it. You don't need it—FlowReco uses WASAPI loopback to record internal audio directly from your default output device.",
			},
		],
	},
		...
		tips: [
			{
				...
				description:
					"FlowReco records system audio and microphone on separate tracks, allowing you to adjust levels independently in the editor.",
			},
			{
			...
			},
			{
				...
				description:
					"FlowReco can automatically generate captions for your recording, making content more accessible.",
			},
			{
	...
	faqs: [
		{
			...
			answer:
				"Yes, absolutely. In FlowReco, enable both 'System Audio' and 'Microphone' in the recording options. FlowReco captures both on separate tracks so you can adjust levels independently in the editor.",
		},
		{
			question: "Why can't I find Stereo Mix on Windows 11?",
			answer:
				"Many modern devices hide Stereo Mix or don't include it at all in their drivers. The good news is you don't actually need it anymore. FlowReco uses WASAPI loopback to record internal audio directly from your default output device.",
		},
		{
			question: "Does Game Bar record everything on the desktop?",
			answer:
				"Not really. Game Bar is optimized for recording games and specific application windows, not general desktop activities or File Explorer workflows. For tutorial creation or full-desktop walkthroughs, dedicated tools like FlowReco give you much more control and better results.",
		},
		{
			question: "Will this work on older Windows versions?",
			answer:
				"FlowReco's WASAPI loopback capture works on Windows 10 and Windows 11. It's more reliable than the old Stereo Mix method across different hardware configurations.",
		},
		{
	...
	cta: {
		...
		description:
			"FlowReco makes recording your Windows screen with system audio incredibly simple. No Stereo Mix required, no complex audio routing.",
		buttonText: "Download FlowReco",
		buttonLink: "/download",
		subtitle:
			"Download FlowReco for Windows – free forever • Open-source • 14-day Pro trial",
	},
