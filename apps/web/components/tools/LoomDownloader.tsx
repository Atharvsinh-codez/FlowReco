			...
			<div className="flex flex-col gap-1">
				<div className="flex items-center gap-2">
					...
					<p className="text-sm font-semibold text-gray-900 sm:text-base">
						Switch from Loom to FlowReco — save 20%
					</p>
				</div>
				<p className="text-xs leading-relaxed text-gray-600 sm:text-sm">
					...
					at checkout for 20% off FlowReco Pro.
				</p>
			</div>
			...
			<div className="flex flex-col gap-5 p-5 rounded-2xl border border-blue-200 bg-gradient-to-br from-blue-50 to-white sm:p-7">
				<div className="flex flex-col gap-2">
					...
					<h3 className="text-lg font-semibold text-gray-900 sm:text-xl">
						Bring your whole Loom library to FlowReco
					</h3>
					<p className="text-sm leading-relaxed text-gray-700 sm:text-base">
						Skip the one-by-one downloads. FlowReco Pro's built-in Loom importer
						transfers your entire Loom workspace to FlowReco in a single click —
				...
				<div className="flex flex-col gap-3">
					<div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
						...
						>
							Migrate with FlowReco Pro — save 20%
						</Button>
						<Button
							variant="white"
							size="lg"
	...
	return (
		<div className="flex flex-col gap-5">
			...
			<div className="flex flex-col gap-3 pt-4 border-t border-gray-3 sm:flex-row sm:items-center sm:justify-between">
				...
				>
					Import Loom videos with FlowReco Pro
					<svg
						className="w-3 h-3"
						fill="none"
						viewBox="0 0 24 24"
