			...
			<div className="flex gap-1.5 items-center">
				...
				<TooltipPrimitive.Provider delayDuration={150}>
					<Tooltip
						...
						content="A commercial license to use FlowReco on your desktop — unlimited local recording and editing, plus 20 cloud shareable links per month. No cloud subscription required."
					>
						<button
							type="button"
