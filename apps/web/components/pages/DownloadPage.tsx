						...
						{platform === "windows" && (
							<div className="mt-4 max-w-md">
								...
								<p className="mt-2 text-sm text-gray-8">
									Whilst FlowReco for Windows is in early beta, after downloading and
									running the app, follow the steps above to whitelist FlowReco on
									your PC.
								</p>
							</div>
						)}
						...
						<div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
							<div>
								<h3 className="text-sm font-medium text-gray-12">
									Install the FlowReco CLI
								</h3>
								<p className="mt-1 text-xs leading-5 text-gray-10">
									Already have FlowReco Desktop? Link the bundled CLI for agents,
