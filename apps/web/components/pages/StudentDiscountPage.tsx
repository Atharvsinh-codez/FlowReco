			...
			<div className="relative z-10 px-5 pt-24 pb-36 w-full">
				...
				>
					...
					<motion.p
						...
						custom={2}
					>
						Level up your presentations and portfolio with 30% off FlowReco's premium
				...
				>
					<div className="text-center mb-12">
						...
						<p className="text-lg text-gray-600 max-w-2xl mx-auto">
							...
							collaborating with classmates, FlowReco helps you create professional
					...
					<div className="flex relative z-10 flex-col justify-center items-center mx-auto h-full">
						<div className="text-center max-w-[800px] mx-auto mb-8">
							...
							<p className="text-lg text-gray-10">
								Join thousands of students already using FlowReco to create amazing
								content
							</p>
						</div>
