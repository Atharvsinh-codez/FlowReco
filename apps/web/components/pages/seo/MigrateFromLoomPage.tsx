...
const features = [
	{
		...
		description:
			"Paste a Loom share link or upload a CSV of your whole library. FlowReco downloads and re-hosts every recording for you, with no manual downloads or re-uploads.",
	},
	{
		icon: BadgeDollarSign,
		title: "Half the price of Loom",
		description:
			"FlowReco Pro starts at just $8.16/month per user versus Loom's $18. A genuinely generous free plan is included, with Studio mode free for personal use.",
	},
	{
		icon: ShieldCheck,
		title: "Open source & private",
		description:
			"FlowReco is fully open source and privacy-first. Audit the code, self-host the whole stack, or password-protect sensitive shares. Your call.",
	},
	{
		icon: Database,
...
const steps = [
	{
		title: "Create your free FlowReco account",
	...
	},
	{
		...
		description:
			"FlowReco re-hosts your videos and they appear in your caps, ready to share with links, comments and analytics.",
	},
];
...
const faqs = [
	{
		...
		answer:
			"Yes. FlowReco Pro includes a built-in Loom video importer. Paste a Loom share link to bring a single video across, or upload a CSV to bulk import your whole library directly into FlowReco.",
	},
	{
		question: "How does bulk migrating from Loom work?",
		answer:
			"Download our CSV template, add a row per video with the Loom URL, the user's email, and an optional space name, then upload it. FlowReco imports each recording for the matching organization member and places it in the right space, up to 500 videos at a time.",
	},
	{
		question: "Do I need to download my Loom videos first?",
		answer:
			"No. FlowReco fetches each Loom recording directly from the share link and re-hosts it for you. There's no manual downloading or re-uploading involved.",
	},
	{
		question: "Is migrating from Loom free?",
		answer:
			"Creating a FlowReco account is free, and you can try FlowReco with no credit card. The built-in Loom importer is a FlowReco Pro feature, which starts at just $8.16/month per user, less than half the price of Loom.",
	},
	{
		question: "Will I keep ownership of my recordings?",
		answer:
			"Absolutely. FlowReco is open source, and you can connect your own S3 storage and custom domain for 100% ownership and control of your content. You're never locked into our platform.",
	},
	{
		question: "How is FlowReco different from Loom?",
		answer:
			"FlowReco gives you the simplicity of Loom with the power of professional tools: open source, bring-your-own-storage, better pricing, and a native desktop app that works offline. Plus you actually own your content, and our importer makes switching effortless.",
	},
];
				...
				<div className="flex gap-4 items-start mb-8">
					...
					<div>
						...
						<p className="mt-1 max-w-xl text-sm text-gray-10">
							Bring a single Loom video into FlowReco, or bulk import your whole
		...
		<>
			...
			<div className="overflow-hidden relative px-5 pt-[140px] md:pt-[200px]">
				<div className="mx-auto text-center max-w-[820px]">
					...
					>
						Migrate from Loom to FlowReco in minutes
					</motion.h1>
					...
					>
						Bring your existing Loom videos into FlowReco with the built-in importer.
				...
				>
					...
					<p className="mx-auto mt-4 text-sm text-center text-gray-9">
						This is the Loom importer inside FlowReco.{" "}
						<a
							href={IMPORT_HREF}
			...
			<div className="px-5 mx-auto mt-32 max-w-[1250px] md:mt-44">
				<div className="mx-auto mb-16 text-center max-w-[800px]">
					...
					<p className="text-xl leading-relaxed text-gray-10">
						FlowReco is the open-source screen recorder built to be yours: your
