...
export const agenciesContent: SeoPageContent = {
	...
	featuresTitle: "Why Agencies Choose FlowReco for Client Communication",
	featuresDescription:
		"FlowReco provides everything busy agencies need for efficient, visual client updates that actually get watched",
	...
	recordingModes: {
		...
		description:
			"FlowReco adapts to your client communication needs with flexible recording options",
		modes: [
			{
	...
	video: {
		...
		alt: "FlowReco screen recorder demonstration for agencies",
	},

	useCasesTitle: "How Agencies Use FlowReco for Client Success",
	useCasesDescription:
	...
	faqs: [
		{
			question: "Does FlowReco work on both macOS and Windows?",
			answer:
				"Yes. FlowReco supports both macOS and Windows with desktop apps, so your entire team can use the same workflow regardless of their platform preference.",
		},
		{
		...
		},
		{
			...
			answer:
				"The free version supports recordings up to 5 minutes. For longer client presentations and unlimited recording time, upgrade to FlowReco Pro at $8.16/month (billed annually).",
		},
		{
			question: "Is FlowReco secure enough for confidential client work?",
			answer:
				"Yes. FlowReco is open-source and privacy-first. You can connect your own S3 storage, use a custom domain for share links, and password-protect sensitive videos. This gives you complete control over client data.",
		},
		{
			question: "Can we use our own branding with FlowReco?",
			answer:
				"Yes. FlowReco Pro includes custom domain support (cap.yourdomain.com) so share links reflect your agency's brand. You can also use your own S3 storage for complete data ownership.",
		},
		{
			question: "How does FlowReco pricing work for agency teams?",
			answer:
				"FlowReco Pro is $8.16/month per user (billed annually) and includes unlimited cloud storage, custom domains, team workspaces, and all collaboration features. Volume discounts are available for teams over 10 users.",
		},
	],

	comparisonTable: {
		title: "FlowReco vs. Traditional Agency Communication Methods",
		headers: ["Feature", "FlowReco", "Email + Screenshots", "Video Calls"],
		rows: [
			[
				"Client Engagement",
	...
	migrationGuide: {
		title: "Getting Started with FlowReco for Your Agency",
		steps: [
			"Download FlowReco for all team members (available on Mac and Windows)",
			"Set up FlowReco Pro with custom domain for professional share links",
	...
	cta: {
		...
		buttonText: "Upgrade to FlowReco Pro",
	},
};
