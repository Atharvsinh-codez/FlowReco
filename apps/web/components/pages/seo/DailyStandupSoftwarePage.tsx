...
export const dailyStandupSoftwareContent: SeoPageContent = {
	...
	featuresTitle: "Why FlowReco is the Ideal Daily Standup Software",
	featuresDescription:
		"FlowReco provides everything Agile teams need for efficient, asynchronous daily standups",
	...
	features: [
		...
		},
		{
			...
			description:
				"Ensure sensitive project discussions remain confidential with FlowReco's open-source approach and custom S3 storage options for complete data ownership and NDA compliance.",
		},
		{
	...
	recordingModes: {
		...
		description:
			"FlowReco adapts to your team's Agile workflow with flexible recording options",
		modes: [
			{
	...
	useCasesTitle: "How Agile Teams Use FlowReco for Daily Standups",
	...
	faqs: [
		...
		},
		{
			...
			answer:
				"We recommend keeping recordings under 3 minutes per person, focusing on the classic standup format: what was accomplished, what's planned for today, and any blockers. FlowReco's Instant Mode is perfectly optimized for these quick updates, while Studio Mode offers more flexibility for complex situations.",
		},
		{
			question: "Can we integrate FlowReco with our project management tools?",
			answer:
				"FlowReco provides easy-to-share links that work seamlessly with all major project management and communication platforms including Jira, Trello, Slack, Microsoft Teams, and more. Simply copy the link to your standup recording and paste it into your team's preferred tools.",
		},
		{
			question: "What if someone misses recording their standup?",
			answer:
				"FlowReco's flexibility is perfect for occasional missed standups. Team members can record updates when they're available, and others can easily access the recording later. This is actually an advantage over traditional standups, where missing the meeting means missing the information completely.",
		},
		{
	...
	comparisonTable: {
		title: "FlowReco vs. Traditional Standup Methods",
		headers: ["Feature", "FlowReco", "Video Meetings", "Text-Based Standup Tools"],
		rows: [
			[
	...
	migrationGuide: {
		title: "How to Implement FlowReco for Your Daily Standups",
		steps: [
	...
	video: {
		...
		alt: "FlowReco screen recorder demonstration for daily standup meetings",
	},
