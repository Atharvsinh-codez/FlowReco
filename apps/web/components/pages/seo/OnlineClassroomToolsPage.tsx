...
export const onlineClassroomToolsContent: SeoPageContent = {
	...
	featuresTitle: "Why FlowReco is Essential for Modern Online Classrooms",
	featuresDescription:
		"FlowReco provides educators with powerful tools for creating engaging, accessible asynchronous learning experiences",
	...
	features: [
		...
		},
		{
			...
			description:
				"Maintain complete control over sensitive student data with FlowReco's open-source approach and custom S3 storage options. Create a branded classroom experience with custom domain integration for institutional cohesion.",
		},
		{
		...
		},
		{
			...
			description:
				"Record, edit and share lessons in minutes rather than hours. Educators report saving 3-5 hours weekly by replacing traditional content creation methods with FlowReco's streamlined recording process.",
		},
		{
	...
	recordingModes: {
		...
		description:
			"FlowReco adapts to different teaching scenarios with flexible recording options",
		modes: [
			{
	...
	useCasesTitle: "How Educators Use FlowReco in Virtual Classrooms",
	...
	faqs: [
		{
			...
			answer:
				"Yes, students can use FlowReco to record project presentations, assignments, and peer teaching materials. This is particularly valuable for speech, language, performance, and demonstration-based assessments where text submission doesn't capture the student's full capabilities.",
		},
		{
			question: "How many recordings can I store?",
			answer:
				"FlowReco's free plan includes generous storage for individual educators. For departmental or institution-wide implementation, our paid plans offer expanded storage options, and you can connect your own S3 storage for unlimited self-managed content retention and complete data ownership.",
		},
		{
			question: "Is FlowReco suitable for K-12 vs. university-level teaching?",
			answer:
				"FlowReco is designed for versatility across all educational levels. K-12 educators appreciate the simplicity and privacy controls, while university instructors leverage the professional-quality recording capabilities for complex subject matter. The platform scales with the complexity of your content needs.",
		},
		{
			question: "Does FlowReco integrate with existing LMS platforms?",
			answer:
				"FlowReco provides easy-to-share links and embed codes that work seamlessly with all major Learning Management Systems including Canvas, Blackboard, Moodle, Google Classroom, and more. Simply copy the link to your recording and paste it into your course materials.",
		},
		{
			question: "How does FlowReco improve accessibility for diverse learners?",
			answer:
				"FlowReco supports diverse learning needs by allowing students to control playback speed, pause and review content as needed, and access materials at times that accommodate their individual circumstances. For institutions with specific accessibility requirements, FlowReco's open-source nature allows for custom adaptations.",
		},
	],

	comparisonTable: {
		title: "FlowReco vs. Traditional Online Teaching Methods",
		headers: ["Feature", "FlowReco", "Video Meetings", "Text & Slide Materials"],
		rows: [
			[
	...
	migrationGuide: {
		title: "How to Implement FlowReco in Your Classroom",
		steps: [
			"Download FlowReco for your operating system (Mac and Windows)",
	...
	video: {
		...
		alt: "FlowReco screen recorder demonstration for online classroom teaching",
	},
