...
const features = [
	{
		...
		description:
			"No access keys, endpoints, or buckets to configure. Sign in with Google once, approve access, and FlowReco is ready to store your recordings in your own Drive.",
	},
	{
		icon: HardDriveUpload,
		title: "Every shareable link lives in your Drive",
		description:
			"Once connected, new shareable links upload straight to a private FlowReco folder in your Google Drive. You own the underlying video files, in the account you already trust.",
	},
	{
		icon: Building2,
	...
	},
	{
		...
		description:
			"Share links stay on FlowReco with comments, viewer analytics, chapters, and password protection intact. The recording is simply streamed from your Google Drive instead of FlowReco Cloud.",
	},
	{
		icon: ArrowLeftRight,
		title: "Switch storage whenever you want",
		description:
			"Keep FlowReco Cloud and your own S3 bucket alongside Drive, then choose the active provider with one toggle. Existing recordings keep the storage they were created with.",
	},
	{
		icon: ShieldCheck,
		title: "FlowReco only ever touches its own folder",
		description:
			"FlowReco uses Google's drive.file permission, so it can only see and manage the files it creates for you. The rest of your Google Drive stays completely private to FlowReco.",
	},
];
...
const flow = [
	...
	},
	{
		...
		description:
			"When you share, FlowReco uploads the recording to a private FlowReco folder in your connected Google Drive, individually or for your whole organization.",
	},
	{
		icon: <Link2 className="size-6" strokeWidth={1.75} />,
		title: "3. Share from your Drive",
		description:
			"Copy your FlowReco link. Viewers watch through FlowReco's player while the video is served straight from your own Google Drive after access checks.",
	},
];
...
const comparisonTable: {
	...
	headers: ["Feature", "FlowReco + Google Drive", "Loom", "Vidyard"],
	rows: [
		[
...
const steps = [
	{
		title: "Upgrade to FlowReco Pro",
		description:
			"Connecting your own Google Drive is a FlowReco Pro feature, available for individual creators and entire organizations.",
	},
	{
	...
	},
	{
		...
		description:
			"Click Connect Google Drive, sign in, and approve access. FlowReco creates a private FlowReco folder in your Drive for new uploads.",
	},
	{
		...
		<>
			<div className="overflow-hidden relative px-5 pt-[140px] md:pt-[200px]">
				<div className="mx-auto text-center max-w-[820px]">
					...
					>
						Connect Google Drive to FlowReco and every shareable link uploads to, and
				...
				>
					...
					<p className="mx-auto mt-4 text-sm text-center text-gray-9">
						This is the Google Drive integration inside FlowReco, available on FlowReco
						Pro.
					</p>
				</motion.div>
			</div>
			...
			<div className="px-5 mx-auto mt-32 max-w-[1250px] md:mt-44">
				<div className="mx-auto mb-16 text-center max-w-[800px]">
					...
					<p className="text-xl leading-relaxed text-gray-10">
						FlowReco brings the instant sharing you expect from Loom, while every new
			...
			<div className="px-5 mx-auto mt-32 max-w-[1100px] md:mt-44">
				<div className="mx-auto mb-16 text-center max-w-[800px]">
					<h2 className="mb-3 text-3xl font-medium md:text-4xl text-gray-12">
						How FlowReco and Google Drive work together
					</h2>
					<p className="text-xl leading-relaxed text-gray-10">
						Record once and FlowReco handles the rest, from upload to a shareable
				...
				<p className="mx-auto mt-10 max-w-2xl text-center text-gray-10">
					Prefer object storage instead? FlowReco also lets you{" "}
					<a
					...
					, or see how FlowReco compares as a{" "}
					<a
			...
			<div className="px-5 mx-auto mt-32 max-w-4xl md:mt-44">
				<div className="mx-auto mb-12 text-center max-w-[800px]">
					<h2 className="text-3xl font-medium md:text-4xl text-gray-12">
						FlowReco with Google Drive vs other recorders
					</h2>
				</div>
			...
			<div className="px-5 mx-auto mt-32 max-w-3xl md:mt-44">
				<div className="mx-auto mb-12 text-center max-w-[800px]">
					<h2 className="text-3xl font-medium md:text-4xl text-gray-12">
						How to record to Google Drive with FlowReco
					</h2>
				</div>
			...
			<div className="px-5 mx-auto mt-32 mb-32 max-w-[1000px] md:mt-44 md:mb-44">
				...
				>
					...
					<p className="mb-8 max-w-xl text-xl text-gray-10">
						Download FlowReco, upgrade to Pro, and connect Google Drive for yourself
