...
export const freeScreenRecorderContent = {
	...
	featuresTitle: "Why Choose FlowReco's Free Screen Recorder?",
	featuresDescription:
		"FlowReco provides all the tools you need for powerful, no-cost screen recording",
	...
	features: [
		...
		},
		{
			...
			description:
				"Designed for ease of use, FlowReco makes it simple to record your screen in just a few clicks.",
		},
		{
	...
	useCasesTitle: "Popular Uses for FlowReco's Free Screen Recorder",
	useCasesDescription:
		"Explore how FlowReco can support your recording needs, all at no cost",
	...
	faqs: [
		...
		},
		{
			...
			answer:
				"FlowReco's free plan allows for unlimited recording time, so you can capture your screen without interruptions. Whether you're on <a href='/screen-recorder-mac'>Mac</a> or <a href='/screen-recorder-windows'>Windows</a>, there are no time limits.",
		},
		{
			question: "Can I store my recordings in the cloud?",
			answer:
				"Yes, from just $6/month, FlowReco offers unlimited cloud storage, making it easy to access and share recordings whenever needed.",
		},
		{
			question: "What makes FlowReco's free screen recorder different?",
			answer:
				"FlowReco offers advanced features for free, such as high-quality video capture, easy sharing options, and an intuitive interface, making it ideal for professional use without any cost.",
		},
		{
	...
	video: {
		...
		alt: "FlowReco free screen recorder demo showing high-quality features",
	},

	cta: {
		title: "Get Started with FlowReco – Your Free, High-Quality Screen Recorder",
