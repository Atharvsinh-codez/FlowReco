	...
	const proFeatures = [
		{
			...
			title: "Custom domain",
			description: "Connect your own domain to FlowReco",
		},
		{
		...
		},
		{
			...
			title: "Upload videos",
			description: "Upload custom videos directly to FlowReco",
		},
		{
	...
	const proCheckoutMutation = useMutation({
		mutationFn: async () => {
			...
			if (data.subscription === true) {
				toast.success("You are already on the FlowReco Pro plan");
				onOpenChange(false);
			}
