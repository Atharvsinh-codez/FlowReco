...
export const SeoPageTemplate = ({
	...
	return (
		<>
			...
			{showLoomComparisonSlider && (
				<ComparisonSlider
					leftImage="/app/flowreco-dashboard.webp"
					rightImage="/app/loomdashboard.webp"
					leftAlt="FlowReco Dashboard"
					...
					<div>
						<div className="text-center max-w-[800px] mx-auto mb-10">
							<h2 className="inline-block relative mb-2 text-3xl font-medium text-gray-800 md:text-4xl">
								{content.video.title ?? "See FlowReco in Action"}
							</h2>
							<p className="text-xl leading-relaxed text-gray-10">
								Watch how FlowReco makes screen recording simple, powerful, and
								accessible.
							</p>
						</div>
							...
							{content.video.iframe ? (
								...
								>
									<iframe
										...
										title={content.video.iframe.title || "FlowReco Demo"}
										frameBorder="0"
										allowFullScreen
										style={{
											position: "absolute",
								...
								<div className="overflow-hidden rounded-xl shadow-md">
									<iframe
										...
										title={content.video.alt ?? "FlowReco demo video"}
