...
export const homepageCopy: HomePageCopy = {
	header: {
		...
		variants: {
			default: {
				...
				description:
					"FlowReco is the only screen recording tool you need — three modes in one app that replace your recorder, editor, screenshot tool, and video host. Fully open source, and you can connect your own Google Drive or S3 bucket, so you own every recording.",
			},
		},
		modes: [
			{
		...
		cta: {
			primaryButton: "Upgrade to FlowReco Pro",
		...
		features: [
			{
				...
				description:
					"Connect your own Google Drive or S3 bucket, use FlowReco Cloud, or keep everything local. You're never locked into our infrastructure, perfect for teams with compliance requirements or anyone who values data sovereignty.",
			},
			{
			...
			},
			{
				...
				description:
					"See exactly how FlowReco works, contribute features you need, or self-host for complete control. Join a community of builders who believe great tools should be transparent, extensible, and respect their users.",
			},
			{
				title: "Speed Up Your Workflow With FlowReco AI",
				description:
			...
			},
			{
				...
				description:
					"Switching from Loom? Import your existing recordings directly into FlowReco with our built-in importer. Keep all your content in one place without starting from scratch.",
			},
		],
	},
	bento: {
		eyebrow: "Why FlowReco",
		...
		cards: [
			{
				...
				description:
					"Plug in your own Google Drive or S3 bucket, route to FlowReco Cloud, or keep recordings entirely local. Your videos, your storage, your bill, with no vendor lock-in, ever.",
			},
			{
				key: "ai",
				title: "FlowReco AI Does The Busywork",
				description:
	...
	pricing: {
		...
		lovedBy: "Local-first by default",
		commercial: {
			title: "Desktop License",
			description:
				"A commercial license for the FlowReco desktop app — unlimited local recording and editing.",
			features: [
	...
	faq: {
		...
		items: [
			{
				question: "What is the difference between FlowReco Pro and Desktop License?",
				answer:
					"FlowReco Pro is a paid plan that includes all the features of the Desktop License plus cloud features for seamless sharing and collaboration. Desktop License grants you commercial usage rights for a single user.",
			},
			{
				question: "Is there a free version?",
				answer:
					"Yes! FlowReco is 100% free for personal use. You can record and share locally with Studio Mode. A paid plan is required for commercial usage.",
			},
			{
			...
			{
				question: "How does FlowReco AI work?",
				answer:
					"FlowReco AI is a powerful tool that can be used to generate titles, summaries, clickable chapters, and transcriptions for your recordings. It's available for all FlowReco Pro users and has no usage limits.",
			},
			{
				question: "How is FlowReco different from Loom?",
				answer:
					"FlowReco gives you the best of both worlds: the simplicity of Loom with the power of professional tools. We're open source, support custom storage, offer better pricing, and our desktop app works offline. Plus, you actually own your content. Already using Loom? Our built-in Loom video importer makes switching effortless.",
			},
			{
			...
			},
			{
				...
				answer:
					"Yes! FlowReco Pro includes team workspaces where you can organize recordings, manage permissions, and collaborate. Volume discounts available for teams over 10 users. Contact us for custom enterprise features.",
			},
			{
			...
			{
				question: "Can I use FlowReco for commercial purposes?",
				answer:
					"Absolutely! Any paid plan (Desktop License or FlowReco Pro) includes full commercial usage rights. Use FlowReco for client work, sell courses, or embed recordings anywhere. The free version is for personal use only.",
			},
			{
				question: "Is my data secure?",
				answer:
					"Security is core to FlowReco. As an open source project, our code is fully auditable and transparent — you can see exactly how your data is handled. End-to-end encryption for cloud storage, option to use your own infrastructure, and community-driven security reviews keep your content safe.",
			},
			{
				question: "What about GDPR/HIPAA compliance?",
				answer:
					"FlowReco Pro lets you bring your own storage, including custom S3 buckets in any region or your own Google Drive, for GDPR compliance. For HIPAA and other regulations, our self-hosted option gives you complete control. We also offer signed BAAs for enterprise customers.",
			},
		],
	},
	readyToGetStarted: {
		...
		buttons: {
			primary: "Upgrade to FlowReco Pro",
