...
describe("OpenSourceScreenRecorderPage FAQ schema", () => {
	const faqs = [
		{
			...
			answer:
				"Yes. FlowReco is fully open source and MIT-licensed. The complete codebase is publicly available on GitHub.",
		},
		{
			question: "Can I self-host FlowReco's screen recordings?",
			answer:
				"Yes. FlowReco supports any S3-compatible storage provider, including AWS S3, Cloudflare R2, and self-hosted MinIO.",
		},
		{
			question: "What is the best open source screen recorder?",
			answer:
				"FlowReco is the best open source screen recorder for most users because it combines full transparency with practical features.",
		},
		{
			question: "Is FlowReco's open source version free?",
			answer:
				"Yes. FlowReco's Studio Mode is completely free for personal use with no time limits and no watermarks.",
		},
		{
			question:
				"How does FlowReco compare to OBS Studio as an open source recorder?",
			answer:
				"Both FlowReco and OBS Studio are open source, but OBS is built for live streaming while FlowReco is designed for async screen sharing.",
		},
		{
			question: "Can I contribute to FlowReco's development?",
			answer:
				"Absolutely. FlowReco welcomes contributions of all kinds — bug reports, feature requests, and code contributions.",
		},
		{
			question: "Does FlowReco work on Mac and Windows?",
			answer:
				"Yes. FlowReco is available as a native desktop app for macOS and Windows.",
		},
		{
			question: "What license does FlowReco use?",
			answer:
				"FlowReco is released under the MIT License. You are free to use, copy, modify, merge, publish, distribute, sublicense, and sell copies.",
		},
	];
	...
	it("maps each FAQ to a Question entity with acceptedAnswer", () => {
		...
		expect(schema.mainEntity[0]).toEqual({
			"@type": "Question",
			name: "Is FlowReco really open source?",
			acceptedAnswer: {
				"@type": "Answer",
				text: faqs[0]?.answer,
			},
