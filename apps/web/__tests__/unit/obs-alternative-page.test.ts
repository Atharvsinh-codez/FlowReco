...
describe("ObsAlternativePage FAQ schema", () => {
	const faqs = [
		{
			...
			answer:
				"OBS Studio is the best tool for live streaming, but it's complex and saves files locally. FlowReco is designed for async screen sharing.",
		},
		{
		...
		},
		{
			...
			answer: "Yes. FlowReco is fully open source and MIT-licensed on GitHub.",
		},
		{
			question: "Can FlowReco do live streaming like OBS?",
			answer:
				"No. FlowReco is built for async screen recording and sharing, not live streaming.",
		},
		{
			question: "Does FlowReco support the same recording quality as OBS?",
			answer:
				"Yes. FlowReco records at up to 4K resolution and 60 frames per second with system audio and microphone.",
		},
		{
			question: "What happens to my recordings after I stop recording in FlowReco?",
			answer:
				"FlowReco automatically uploads your recording and generates a shareable link in seconds.",
		},
		{
			question: "Does FlowReco work on Mac and Windows like OBS?",
			answer:
				"Yes. FlowReco is available as a native desktop app for macOS and Windows, just like OBS.",
		},
		{
	...
	it("maps each FAQ to a Question entity with acceptedAnswer", () => {
		...
		expect(schema.mainEntity[0]).toEqual({
			"@type": "Question",
			name: "Why would I use FlowReco instead of OBS Studio?",
			acceptedAnswer: {
				"@type": "Answer",
				text: faqs[0]?.answer,
			},
