...
describe("DeveloperDocumentationVideosPage FAQ schema", () => {
	const faqs = [
		...
		},
		{
			...
			answer:
				"FlowReco generates a shareable link the moment you stop recording. You can paste this URL directly into Notion, Confluence, Docusaurus, GitBook.",
		},
		{
			question: "Can I record my terminal and IDE output in 4K?",
			answer: "Yes. FlowReco records at up to 4K resolution at 60fps.",
		},
		{
			question: "Does FlowReco auto-generate transcripts for documentation?",
			answer:
				"Yes. FlowReco auto-generates captions and transcripts for every recording using AI transcription.",
		},
		{
			question: "How do I share a documentation video with my team or users?",
			answer:
				"FlowReco generates a shareable link immediately when you stop recording — no upload wait, no file attachment.",
		},
		{
			question: "Can I record videos for private internal documentation?",
			answer:
				"Yes. FlowReco supports password protection on individual recordings and expiry dates on share links.",
		},
		{
			question: "What is the best screen recorder for developer documentation?",
			answer:
				"FlowReco is the best screen recorder for developer documentation because it combines 4K recording quality, instant shareable links, AI-generated transcripts, and self-hosted storage.",
		},
		{
			question: "Does FlowReco work for recording API demos and SDK walkthroughs?",
			answer:
				"Yes. FlowReco is designed exactly for this use case. Record your terminal, IDE, browser, API client.",
		},
	];
