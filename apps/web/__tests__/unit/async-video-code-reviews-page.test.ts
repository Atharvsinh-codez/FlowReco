...
describe("AsyncVideoCodeReviewsPage FAQ schema", () => {
	const faqs = [
		...
		},
		{
			...
			answer:
				"FlowReco generates a shareable link the moment you stop recording — no upload wait, no file attachment.",
		},
		{
			question:
				"Does FlowReco work with GitHub, GitLab, Linear, and other developer tools?",
			answer: "Yes. FlowReco produces a standard URL that you can paste anywhere.",
		},
		{
		...
		},
		{
			...
			answer: "Yes. FlowReco supports password protection on individual recordings.",
		},
		{
			question: "What is the best tool for async video code reviews?",
			answer:
				"FlowReco is the best tool for async video code reviews for engineering teams.",
		},
	];
