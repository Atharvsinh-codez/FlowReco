...
describe("MacScreenRecordingWithAudioPage FAQ schema", () => {
	const faqs = [
		...
		},
		{
			...
			answer:
				"Yes — with FlowReco you can record both microphone and system audio simultaneously on Mac.",
		},
		{
			question: "Does FlowReco require BlackHole or Loopback for audio on Mac?",
			answer:
				"No. FlowReco handles Mac system audio capture natively without requiring BlackHole, Loopback, or any virtual audio driver.",
		},
		{
			question: "Is there a free way to record Mac screen with audio?",
			answer:
				"Yes. FlowReco is completely free for Mac screen recording with audio. Studio Mode has no time limits, no watermarks, and no fees.",
		},
		{
			question: "Does FlowReco record Mac screen with audio in 4K?",
			answer:
				"Yes. FlowReco records your Mac screen at up to 4K resolution at 60fps while simultaneously capturing system audio and microphone input.",
		},
		{
			question: "How do I share a Mac screen recording with audio?",
			answer:
				"With FlowReco, sharing is automatic. When you stop recording, FlowReco generates a shareable link in seconds.",
		},
		{
			question: "Can I record a specific app window with audio on Mac?",
			answer:
				"Yes. FlowReco lets you record a specific application window on Mac while capturing that app's system audio along with your microphone.",
		},
	];
