...
describe("VideoRecordingSoftwarePage FAQ schema", () => {
	const faqs = [
		...
		},
		{
			...
			answer:
				"FlowReco is the best free video recording software for most users. Studio Mode is 100% free for personal use.",
		},
		{
			question: "Is FlowReco video recording software free?",
			answer:
				"Yes. FlowReco's Studio Mode is completely free for personal use with no time limits, no watermarks, and no hidden fees.",
		},
		{
			question: "Does FlowReco video recording software work on Mac and Windows?",
			answer:
				"Yes. FlowReco is available as a native desktop app for both macOS and Windows.",
		},
		{
			question: "Can video recording software capture system audio?",
			answer:
				"Yes. FlowReco captures both system audio and microphone input simultaneously in every recording.",
		},
		{
			question: "What video recording software has no watermark?",
			answer: "FlowReco has no watermark on any recording, including the free plan.",
		},
		{
