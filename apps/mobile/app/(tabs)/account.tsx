...
export default function AccountScreen() {
	...
	const confirmSignOut = () => {
			...
			ActionSheetIOS.showActionSheetWithOptions(
				{
					...
					message: "Remove this FlowReco session from your device?",
		...
		Alert.alert("Sign out", "Remove this FlowReco session from your device?", [
	...
	if (auth.status === "signedOut") {
		return (
			<Screen scroll>
				<SignInPanel title="Sign in to FlowReco" />
			</Screen>
		);
	}
	...
	return (
		...
		>
					...
					<View style={styles.identityRow}>
						...
						<View style={styles.identityText}>
							<Text numberOfLines={1} style={styles.name}>
								{auth.bootstrap.user.name ?? "FlowReco user"}
							</Text>
			...
			<SettingsSection title="Session">
				<SettingsRow
					accessibilityValueText={
						accountAction === "signOut" ? "Signing out of FlowReco" : undefined
					}
