...
const getEmailRequestErrorMessage = (error: unknown) => {
	if (error instanceof MobileApiError) {
		...
		if (error.status === 403) {
			return "This email cannot be used to sign in to FlowReco.";
		}
	}
			...
			>
				...
				<View style={styles.formStack}>
					...
					<Text style={styles.legalText}>
						{isCodeStep
							? "By entering your email, you acknowledge that you have both read and agree to FlowReco's "
							: "By typing your email and clicking continue, you acknowledge that you have both read and agree to FlowReco's "}
						<Text
