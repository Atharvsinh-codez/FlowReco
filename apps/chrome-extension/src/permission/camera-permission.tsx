...
import { DoodleBoilFilter, FlowRecoBrand } from "../shared/cap-brand";
...
const headlines: Record<Status, { title: string; lede: string }> = {
	idle: {
		...
		lede: "Allow access once so FlowReco can show your camera preview and record your voice.",
	},
	requesting: {
	...
	ready: {
		...
		lede: "Pick the camera FlowReco should use. It's remembered for every recording.",
	},
	error: {
		title: "FlowReco needs access",
		lede: "Allow access once so FlowReco can show your camera preview and record your voice.",
	},
};
	...
	return (
		<>
				...
				{status === "ready" && devices.length > 0 && (
					<div className="card device-card">
						<label className="field">
							<span>Camera FlowReco should use</span>
							<select
			...
			<p className="footnote">
				Chrome remembers this. FlowReco only uses your camera while you record.
			</p>
		</>
	);
}
