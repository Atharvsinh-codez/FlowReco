...
<html>
	<head><title>FlowReco Repro Capture Target</title></head>
...
const launchExtensionContext = async () => {
	...
	const context = await chromium.launchPersistentContext(userDataDir, {
		...
		args: [
			...
			"--auto-select-tab-capture-source-by-title=FlowReco Repro Capture Target",
			"--auto-select-desktop-capture-source=FlowReco Repro Capture Target",
