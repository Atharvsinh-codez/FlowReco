...
<html>
	<head>
		<title>FlowReco E2E Capture Target</title>
		<style>
			html,
			body {
				margin: 0;
	...
	<body>
		...
		<script>
			...
			function draw() {
				...
				context.fillText("FlowReco extension recording E2E " + frame, 48, 96);
...
const launchExtensionContext = async () => {
	...
	const context = await chromium.launchPersistentContext(userDataDir, {
		...
		args: [
			...
			"--auto-select-desktop-capture-source=FlowReco E2E Capture Target",
			"--auto-select-tab-capture-source-by-title=FlowReco E2E Capture Target",
