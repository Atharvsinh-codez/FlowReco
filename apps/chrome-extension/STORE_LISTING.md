...
Name: FlowReco - Screen Recorder & Screen Capture
...
Website: https://github.com/Atharvsinh-codez/FlowReco

Support: https://github.com/Atharvsinh-codez/FlowReco/issues

Privacy policy: https://github.com/Atharvsinh-codez/FlowReco#privacy

## Detailed Description (paste as plain text)

FlowReco is the open source screen recorder for Chrome. Record your screen, a window, the current browser tab, or camera-only video. Your recording uploads while you record, so a shareable link is ready the moment you stop. No exports, no waiting, no switching tools.

WHY PEOPLE CHOOSE FLOWRECO

FlowReco is a Loom alternative built on a simple idea: your recordings belong to you. FlowReco is fully open source, lets you connect your own storage, and gives you a fast, lightweight recorder that stays out of your way.

• Truly open source: inspect every line of code, contribute, or self-host the entire stack.
• Own your recordings: use FlowReco Cloud or connect your own S3 bucket. No vendor lock-in, ever.
• Instant share links: video uploads as you record, so the link is live the second you stop.
• FlowReco AI: auto-generated titles, summaries, clickable chapters, and searchable transcripts for every recording.
• Built for teams: comments, reactions, viewer analytics, password-protected shares, custom domains, and team workspaces.
• Switching from Loom? Import your existing Loom videos directly into FlowReco with the built-in importer.
...
1. Click the FlowReco icon and pick tab, screen, window, or camera.
2. Choose your microphone and camera, then hit record.
3. Stop recording. Your video is already uploaded to your FlowReco workspace and the share link is ready.

FLOWRECO EVERYWHERE

The extension is part of the FlowReco platform: native desktop apps for macOS and Windows, a web recorder, and a shared library on the FlowReco server you configure. Recordings stay connected to your workspace wherever you capture them.

FlowReco is free and open source. Connect a compatible FlowReco server to use sharing, collaboration, custom storage, and optional AI features under your control.

Open source on GitHub: https://github.com/Atharvsinh-codez/FlowReco
...
Name strategy: "FlowReco - Screen Recorder & Screen Capture" leads with the brand and covers the two highest-volume queries, matching how the top competitor titles its listing without keyword spam.
...
The SVG sources use the platform UI sans-serif stack so no commercial font files are bundled.
...
<fontconfig>
  <dir>/path/to/FlowReco/apps/chrome-extension/public/fonts</dir>
...
5. The FlowReco share page (player, transcript/chapters) after a recording is available.
...
- identity: sign the user in to their FlowReco account.
